...
class DipaPembayaranChecklistSinkronisasiSaiba extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_dipa_pmb_check_sink_saiba', function (Blueprint $table) {
            ...
            $table->enum('dipa_status_sinki',array('0','1'))->default(0); // 0=belum sinkronisasi 1 = sinkronisasi
            // foreign key
    ...
    {
        Schema::dropIfExists('tbl_dipa_pembayaran_checklist_saiba');
    }
}

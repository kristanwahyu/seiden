...
@section('sidebar')
    @include('sidebar.operator_perlengkapan')
@endsection
...
<div class="main-content">
    ...
    <div class="breadcrumb-wrapper">
        <ul class="breadcrumb">
          <li><a href="{{ url('/dashboard-perlengkapan') }}"><i class="fa fa-home fa-fw"></i></a></li>
          <li class="active-bread"><a href="{{ url('/sinkronisasi-perlengkapan') }}">Sinkronisasi perlengkapan</a></li>
        </ul>
    </div>
    {{-- End Breadcrumb --}}
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="text-left clearfix">
                                      <a href="/dashboard-perlengkapan/" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>

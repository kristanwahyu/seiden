              ...
              <div class="col-md-12">
                <div class="panel">
                  <div class="panel-heading">
                      <h3 class="panel-title">Daftar Data Yang Harus Disinkronisasi</h3>
                  </div>
                  {{-- awal panel body --}}
...
<script>
  'use strict';
    ...
    var table = $('#myTable').DataTable({
        ...
        "ajax":{
            type : "GET",
            url : "/dashboard-perlengkapan/show/"
        },
        "columns": [
            {
                title: "NO",
            ...
            },
            {
                ...
                name: 'action',
                render: function (data) {
                    var actions = `<a href="/sinkronisasi-perlengkapan/${data['dipa_pembayaran_id']}" class="btn btn-success" role="button">Sinkronisasi</a>`;

...
@section('title', 'Dashboard Operator SAIBA')
    ...
    var table = $('#myTable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                name: 'action',
                render: function (data) {
                    var actions = `<a href="/sinkronisasi-saiba/${data['dipa_pembayaran_id']}" class="btn btn-success" role="button">Sinkronisasi</a>`;

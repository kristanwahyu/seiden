...
@section('sidebar')
    @include('sidebar.operator_simak')
@endsection
...
<div class="main-content">
    ...
    <div class="breadcrumb-wrapper">
        <ul class="breadcrumb">
          <li><a href="{{ url('/dashboard-simak') }}"><i class="fa fa-home fa-fw"></i></a></li>
          <li class="active-bread"><a href="{{ url('/sinkronisasi-simak') }}">Sinkronisasi SIMAK</a></li>
        </ul>
    </div>
    {{-- End Breadcrumb --}}
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="text-left clearfix">
                                      <a href="/dashboard-simak/" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
    ...
    if (isConfirm) {
        $.ajax({
            ...
            success : function(data, status){
              ...
              window.location.replace("/dashboard-simak");
            },

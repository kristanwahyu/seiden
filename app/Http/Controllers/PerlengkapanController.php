...
class PerlengkapanController extends Controller
{
	...
	{ 
		...
		->join('tbl_dipa_pmb_check_sink_perlengkapan', 'tbl_dipa_pmb_check_sink_perlengkapan.dipa_pembayaran_id','=','tbl_dipa_pembayaran.dipa_pembayaran_id')
		->where('tbl_dipa_pmb_check_spp.dipa_sinkronisasi_perlengkapan','1')
		->where('tbl_dipa_pmb_check_sink_perlengkapan.dipa_status_sink', '0')
    ...
    // return compact('data');
    return view('pages.operator_perlengkapan.sinkronisasi', compact('data'));
	}
	...
	public function store(Request $request){
		...
		$perlengkapan = DipaPembayaranSyncPerlengkapan::where('dipa_pembayaran_id', $request->id)
			->update([

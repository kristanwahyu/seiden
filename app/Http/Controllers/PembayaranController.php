...
class PembayaranController extends Controller
{
    ...
    {   
        ...
        $data['total'] = DB::table('tbl_dipa_akun')
                ...
                ->first([
                    DB::raw('SUM(tbl_dipa_akun_detail.dipa_harga_satuan * tbl_dipa_akun_detail.dipa_volume) as total, SUM(tbl_dipa_pembayaran.dipa_pembayaran_nilai) as total_bayar')
                    ]);
